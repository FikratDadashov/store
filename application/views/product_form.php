...
<head>
    ...
    <script type="text/javascript">
        ...
        Stripe.setPublishableKey('pk_test_51GtDCCC6fzJfyPcngcqEWEB3Fu6zmzB3PwHjfxnGhAuicuyOqYVSV0XyJfSrCWyzbA9dTuj0JMuVKwwMekM3sYGx00S7OG4dgN');
            ...
            <div class="card">
                ...
                <div class="card-body bg-light">
                    ...
                    <div id="payment-errors"></div>  
                     <form method="post" id="paymentFrm" enctype="multipart/form-data" action="<?php echo base_url(); ?>user/check">
                        ...
                        <input type="hidden" name="postcode" value="<?php echo $value['postcode'] ?>" >
                        <input type="hidden" name="country_id" value="<?php echo $value['country_id'] ?>" >            
